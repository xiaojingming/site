...
const vscodeImg = '/download/vscode.webp'
const jetbrainsImg = '/download/jetbrains.webp'
const vscodeDisableImg = '/download/vscode_disable.webp'
const jetbrainsDisableImg = '/download/jetbrains_disable.webp'
const jetbrainsContent = '/download/jetbrains_download.webp'
const vscodeIcon = '/download/vscode_icon.webp'
const jetbrainsIcon = '/download/jetbrains_icon.webp'
const cliImg = '/download/cli.webp'
const cliDisableImg = '/download/cli_disable.webp'
const cliIcon = '/download/cli_icon.webp'
const ZhDownloadStep1 = '/download/zh/download_step1.webp'
const ZhDownloadStep2 = '/download/zh/download_step2.webp'
const EnDownloadStep1 = '/download/en/download_step1.webp'
const ZhCliInstall = '/download/zh/cli_install.webp'
const EnCliInstall = '/download/en/cli_install.webp'
const EnDownloadStep2 = '/download/en/download_step2.webp'
